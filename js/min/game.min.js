...
function overlayOn(){var e=document.querySelector(".overlay");buoy.addClass(e,"active")}[].forEach.call(document.querySelectorAll(".home button"),function(e){e.addEventListener("click",function(){if(buoy.hasClass(this,"create")){var e=document.querySelector(".game");buoy.addClass(e,"active")}else buoy.hasClass(this,"join")?overlayOn():buoy.hasClass(this,"build")&&overlayOn()})});